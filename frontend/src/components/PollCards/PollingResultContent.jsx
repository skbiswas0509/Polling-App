...
const PollOptionVoteResult =({label, optionVotes, totalVotes}) =>{
    ...
    return (
        <div className='w-full bg-slate-200/80 rounded-md h-6 release mb-3'>
            <div className='bg-sky-900/10 h-6 rounded-md' style={{width: `${progress}%`}}>
            </div>
